 ...
 */
authRoutes.post("/signUp", authController_1.register);
/**
 * @swagger
 * /api/auth/remove:
 *   post:
 ...
 *         description: Internal server error
 */
authRoutes.post("/remove", authController_1.deleteUser);
/**
 * @swagger
 * /api/auth/addAdmin:
 *   post:
 ...
 *         description: Internal server error
 */
authRoutes.post("/addAdmin", authController_1.addAdmin);
/**
 * @swagger
 * /api/auth/allAdmin:
 *   get:
 ...
 *         description: Internal server error
 */
authRoutes.get("/allAdmin", authController_1.listAllAdmin);
/**
 * @swagger
 * /api/auth/addnuprc:
 *   post:
 ...
 *         description: Internal server error
 */
authRoutes.post("/addnuprc", authController_1.addNuprc);
/**
 * @swagger
 * api/auth/allnuprc:
 *   get:
 ...
 *         description: Internal server error
 */
authRoutes.get("/allnuprc", authController_1.listAllNUPRC);
/**
 * @swagger
 * /api/auth/addDRA:
 *   post:
 ...
 *         description: Internal server error
 */
authRoutes.post("/addDRA", authController_1.addDRA);
/**
 * @swagger
 * /api/auth/allDra:
 *   get:
 ...
 *         description: Internal server error
 */
authRoutes.get("/allDra", authController_1.listAllDRA);
/**
 * @swagger
 * /api/auth/addSettlor:
 *   post:
 ...
 *         description: Internal server error
 */
authRoutes.post("/addSettlor", authController_1.addSettlor);
/**
 * @swagger
 * /api/auth/allSettlor:
 *   get:
 ...
 *         description: Internal server error
 */
authRoutes.get("/allSettlor", authController_1.listAllSettlor);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
authRoutes.post("/removeSettlor", authController_1.deleteSettlor);
/**
 * @swagger
 * /api/auth/test:
 *   get:
